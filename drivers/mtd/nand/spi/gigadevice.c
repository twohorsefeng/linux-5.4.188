...
#define ESMT_1_STATUS_ECC_MASK                  (7 << 4)
#define ESMT_1_STATUS_ECC_NO_BITFLIPS	        (0 << 4)
#define ESMT_1_STATUS_ECC_1_3_BITFLIPS	        (1 << 4)
#define ESMT_1_STATUS_ECC_UNCOR_ERROR	        (2 << 4)
#define ESMT_1_STATUS_ECC_4_6_BITFLIPS	        (3 << 4)
#define ESMT_1_STATUS_ECC_7_8_BITFLIPS	        (5 << 4)
...
static int esmt_2_ooblayout_ecc(struct mtd_info *mtd, int section,
				  struct mtd_oob_region *region)
{
	if (section)
		return -ERANGE;
...
static int esmt_2_ooblayout_free(struct mtd_info *mtd, int section,
				   struct mtd_oob_region *region)
{
	if (section)
		return -ERANGE;
...
static const struct mtd_ooblayout_ops esmt_2_ooblayout = {
	.ecc = esmt_2_ooblayout_ecc,
	.free = esmt_2_ooblayout_free,
};

static int esmt_1_ecc_get_status(struct spinand_device *spinand,
					 u8 status)
{
	switch (status & ESMT_1_STATUS_ECC_MASK) {
	case ESMT_1_STATUS_ECC_NO_BITFLIPS:
		return 0;

	case ESMT_1_STATUS_ECC_1_3_BITFLIPS:
		/* 1-3 bits are flipped. return the maximum. */
		return 3;

	case ESMT_1_STATUS_ECC_UNCOR_ERROR:
		return -EBADMSG;

	case ESMT_1_STATUS_ECC_4_6_BITFLIPS:
		/* 4-6 bits are flipped. return the maximum. */
		return 6;

	case ESMT_1_STATUS_ECC_7_8_BITFLIPS:
...
static const struct spinand_info gigadevice_spinand_table[] = {
	SPINAND_INFO("F50L2G41KA(2V)",
		     ...
		     0,
		     SPINAND_ECCINFO(&esmt_2_ooblayout, esmt_1_ecc_get_status)),
